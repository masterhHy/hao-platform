...
public class RouteEnhanceCacheUtil {
    ...
    private static final String BLACKLIST_CHACHE_KEY_PREFIX = "ak:route:blacklist:";
    private static final String RATELIMIT_CACHE_KEY_PREFIX = "ak:route:ratelimit:";
    private static final String RATELIMIT_COUNT_KEY_PREFIX = "ak:route:ratelimit:cout:";

    public static String getBlackListCacheKey(String ip) {
        if (SystemConstant.LOCALHOST.equalsIgnoreCase(ip)) ip = SystemConstant.LOCALHOST_IP;

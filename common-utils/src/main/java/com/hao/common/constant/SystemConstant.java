...
public class SystemConstant {
     ...
     * Gateway请求头TOKEN值
     */
    public static final String GATEWAY_TOKEN_VALUE = "ak:gateway:123456";
     ...
     * 验证码 key前缀
     */
    public static final String CODE_PREFIX = "ak.captcha.";
     ...
     * 注册用户角色ID
     */
    public static final String REGISTER_ROLE_ID = "2";
